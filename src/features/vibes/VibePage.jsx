  ...
  return (
    <div className="container py-5 vibe-container">
      <div className="d-flex align-items-center vibe-header">
        <button className="btn btn-outline-secondary d-flex align-items-center vibe-back-button" onClick={() => navigate("/my-vibes")}>
        ...
        <h2 className="fw-bold vibe-heading">Vibe</h2>
      </div>

      <div className="vibe-top-buttons">
        <button className="btn btn-primary btn-sm d-flex align-items-center vibe-interaction-btn" onClick={() => {
        ...
        <button className="btn btn-light btn-sm d-flex align-items-center vibe-edit-btn" onClick={() => setEditing(true)}>
        ...
        <button className="btn btn-light btn-sm d-flex align-items-center vibe-settings-btn" onClick={() => setShowSettings(true)}>
          <svg width="18" height="18" fill="none" stroke="#2f57d7" strokeWidth="2" viewBox="0 0 20 20">
            ...
            {vibe.type === "BUSINESS" && (
              <BusinessVibeForm
                ...
                onSave={async (updated) => {
                  ...
                  if (!currentId) {
                    alert("Ошибка: Vibe ID отсутствует.");
                    return;
                  }
