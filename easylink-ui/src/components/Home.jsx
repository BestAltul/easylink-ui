  ...
  return (
    <div className="container text-center py-5">
      ...
      <p className="text-muted" style={{ animation: "fadeIn 2s" }}>
        Curious how EasyLink empowers your digital life? <a href="/about" className="text-primary">Learn more</a>
      </p>
      <button
        onClick={handleClick}
      ...
      <div className="row mt-5 justify-content-center" style={{ animation: "fadeIn 2s" }}>
        ...
        {[{
          ...
          <div key={idx} className="col-md-4 mb-4 d-flex justify-content-center">
            <div className="card p-4 shadow-sm" style={{ width: "100%", maxWidth: "400px", minHeight: "220px", transition: "transform 0.3s, box-shadow 0.3s" }}>
